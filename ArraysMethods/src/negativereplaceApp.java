//Write a java program to replace all the negative numbers in an integer array to 0(zero)
import java.util.Scanner;
public class negativereplaceApp {
	public static void main(String[] args) {
		Scanner scan=new Scanner(System.in);
		System.out.println("Enter Array-1 Length");
		int arr1[]=new int[scan.nextInt()];
		System.out.println("Enter "+arr1.length+" number of elements which includes both +ve and -venumbers");
